...
namespace VastAdventureAndriod.VastAdventureUI
{
   ...
   public class AchievementUI:Control,AchievementUIInterface, IListBoxItem
   {
      ...
      public AchievementUI(AchievementModel achievement,EngineRectangle bounds):base(achievement.Name,"",bounds,Color.White)
      {
         ...
         imageReference.Add(Enums.cState.none.ToString(), "defaultTexture"); // doesn't have achievement
         imageReference.Add(Enums.cState.hover.ToString(), "defaultTexture"); // has achievement
