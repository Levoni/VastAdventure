...
{
   [Serializable]
   public class NewLocationScreen : BasicScreen
   {
      ...
      public void Init(int eventId)
      {
         ...
         locationLabel = new Label("locationLabel", locationScreenModel.locationName, new EngineRectangle(viewport.X, viewport.Y, viewport.Width, viewport.Height / 10), Color.DarkGray);
         ...
         Button changeLocation = new Button("btnMoveLocation", "Move Location", new EngineRectangle(viewport.X, (viewport.Height / 10 * (9 - 1)) - 50, viewport.Width, viewport.Height / 10), Color.DarkGray);
         ...
         changeLocation.setImageReferences("button_gray_outline_none", "button_gray_outline_hover", "button_gray_outline_pressed", "button_gray_outline_released");
         ...
         for (int i = 0; i < locationScreenModel.Options.Count; i++)
         {
            ...
            if (precheck)
            {
               Button tempButton = new Button(i.ToString(), locationScreenModel.Options[i].OptionDescription, new EngineRectangle(viewport.X, (viewport.Height / 10 * (9 - visibleOptionsCount - 2)) - 50, viewport.Width, viewport.Height / 10), Color.DarkGray);
