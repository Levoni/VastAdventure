...
namespace VastAdventureDesktop.Screens
{
   ...
   public class MainMenu : BasicScreen
   {
      ...
      private void InitializeAcheivementMenu()
      {
         ...
         //Book order (3,2,4,1)
         AchievementUI HiddenCompartment = new AchievementUI(AchievementService.achievements["Knowledge Opens Doors"], new EngineRectangle(10, viewport.Height / 10 * 9, (viewport.Width - 20), viewport.Height / 10));
         HiddenCompartment.minFontScale = 0;
         achievementList.AddItem(HiddenCompartment);
