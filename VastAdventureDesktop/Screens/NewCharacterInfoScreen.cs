...
namespace VastAdventureDesktop.Screens
{
   ...
   public class NewCharacterInfoScreen : BasicScreen
   {
      ...
      public override void Init()
      {
         ...
         bar = new ProgressBar("bar", model.experience + "/" + (model.level * 100).ToString(), new EngineRectangle(viewport.X + viewport.Width / 2, viewport.Y + viewport.Height / 30 * 6 + 100, viewport.Width / 2 - 50, 50), Color.White, "dark_gray", Color.White);
