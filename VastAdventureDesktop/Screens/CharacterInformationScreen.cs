...
namespace VastAdventureDesktop.Screens
{
   ...
   public class CharacterInformationScreen : BasicScreen
   {
      ...
      public override void Init()
      {
         ...
         {
            if (inventory.items[i].itemDescription == "map")
            {
               Button newButton = new Button("Map", inventory.items[i].itemDescription, new EngineRectangle(viewport.X + 50, viewport.Y + 50 + viewport.Height / 20 * (12 + i), (viewport.Width - 50) / 8, viewport.Height / 20), Color.Black);
               ...
               newButton.padding = new int[]
{
            ...
            {
               Label newLabel = new Label("Item:" + i.ToString(), "- " + inventory.items[i].itemDescription, new EngineRectangle(viewport.X + 50, viewport.Y + 50 + viewport.Height / 20 * (12 + i), (viewport.Width - 50) / 8, viewport.Height / 20), Color.Black);
