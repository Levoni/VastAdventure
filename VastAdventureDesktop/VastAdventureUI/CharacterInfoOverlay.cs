...
namespace VastAdventureDesktop.VastAdventureUI
{
   ...
   public class CharacterInfoOverlay:Base.UI.GUI
   {
      ...
      {
         base.UnInitialize();
         parentScene.bus.Unsubscribe(visibilityEvent);
      }
      ...
      public override void Init(EventBus ebus, Scene parentScene)
      {
         ...
         goToCharacterInfo = new Button("btnGoToCharacterInfo", "", new Base.Utility.EngineRectangle(viewport.X + 50,viewport.Y + 50, viewport.Width / 10, viewport.Width / 10), Microsoft.Xna.Framework.Color.Black);
